...
Safari on recent iOS versions (6 and 7) has [a serious issue](https://github.com/scottjehl/Device-Bugs/issues/36) with viewport units, rendering them unusable in many cases.
