...
Due to the shortcomings of `localStorage`, there are calls—especially from browser vendors—[to stop advocating for and building examples that use it](http://paul.kinlan.me/we-need-to-kill-off-the-localstorage-api).